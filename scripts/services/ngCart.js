...
//            console.log("ngCart getShipping: shipping cost"+this.getCart().shipping);
//            console.log("ngCart getShipping: sub total"+this.getSubTotal());
            if (this.getCart().items.length == 0) return 0;
            if(this.getSubTotal() < 200) return  this.getCart().shipping;
            return 0;
        };
